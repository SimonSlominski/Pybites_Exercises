"""
NAME: Bite 106. Strip out vowels and count the number of replacements
...
def strip_vowels(text: str) -> Tuple[str, int]:
    ...
    # Vowels counter
    number_of_vowels_found = len([x for x in text.lower() if x in vowels])

    # Change vowels to '*' star
    replaced_text = re.sub("[aeiouAEIOU]", "*", text)

    # Return vowels counter and altered text
