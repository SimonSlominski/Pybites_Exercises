...
def get_workout_motd(day):
    ...
    # First solution
    day_titled = str(day).title()

    if day_titled not in WORKOUT_SCHEDULE.keys():
        return INVALID_DAY
    elif day_titled == 'Saturday' or day_titled == 'Sunday':
        return f"Chill out!"
    elif day_titled in WORKOUT_SCHEDULE.keys():
        return f"Go train {WORKOUT_SCHEDULE.get(day_titled)}"
